...
# Resume Points
- Built a lossless file compression tool using Huffman coding with a custom min-heap for optimal prefix-free encoding via a greedy algorithm, achieving up to 54% reduction in file size.
